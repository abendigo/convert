...
// Replaces interpolate()/pluralSelect()/genderSelect() from the hand-rolled
// version — one call handles plain interpolation, plural, and gender
// select, since all three are just ICU MessageFormat argument types.
